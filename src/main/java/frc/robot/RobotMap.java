...
public class RobotMap {
  ...
  //left motors
  public static int leftMotort1 = 1;
  public static int leftMotort2 = 11;
  public static int leftMotort3 = 12;
  
  //right motors
  public static int rightMotort4 = 2;
  public static int rightMotort5 = 9;
  public static int rigthMotort6 = 10;
  
  //green wheels
  public static int greenWheelTop = 5;
  public static int greenWheelBottom = 7;
